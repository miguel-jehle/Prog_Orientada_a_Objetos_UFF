...
public class PrincipalLance {
    @Autowired
    private LanceService lanceService; //  = FabricaDeServicos.getServico(LanceService.class); // new LanceService();
    @Autowired
    private ProdutoService produtoService;  // = FabricaDeServicos.getServico(ProdutoService.class); // new ProdutoService();
